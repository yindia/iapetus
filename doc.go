...
//   - Retries, timeouts, and hooks for reliability and extensibility
...
//	    AddPreRun(func(w *iapetus.Workflow) error { /* ... */ return nil }).
//	    AddPostRun(func(w *iapetus.Workflow) error { /* ... */ return nil })
//
